...
public class GalicianMorphoRuleVerbTer extends GalicianMorphoRuleVerbConjER {

	private String modifiedStem1 = "iv", modifiedStem2 = "te–";
	
	public GalicianMorphoRuleVerbTer(String title, String text) {
		super(title, text);
		this.past = "tido";
