...
public class GalicianMorphoRuleVerbTraer extends GalicianMorphoRuleVerbConjER {

	private String modifiedStem1 = "troux", modifiedStem2 = "trai";

	
	public GalicianMorphoRuleVerbTraer(String title, String text) {
		super(title, text);
		
		String[] TRAERSuffixes = { 
				"er", 													// 0 - infinite 
				"endo", 												// 1 - gerund
	...
	public List<MorphoForm> getForms() {
		...
		int[] modifiedStemForms2 = { 11, 42, 43, 44, 45, 46, 47, 61, 62, 64, 65, 66, 67, 68, 69 };
