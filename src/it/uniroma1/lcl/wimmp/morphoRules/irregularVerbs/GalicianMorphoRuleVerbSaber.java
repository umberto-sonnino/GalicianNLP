...
public class GalicianMorphoRuleVerbSaber extends GalicianMorphoRuleVerbConjER {

	private String modifiedStem1 = "soub", modifiedStem2 = "saib";
	
	public GalicianMorphoRuleVerbSaber(String title, String text) {
		super(title, text);

		String[] SABERSuffixes = { 
				"er", 													// 0 - infinite 
				"endo", 												// 1 - gerund
