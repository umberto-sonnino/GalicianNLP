...
public class GalicianMorphoRuleVerbConjCAR extends GalicianMorphoRuleVerbConjAR {
	
	private String modifiedStem = "";
	
	public GalicianMorphoRuleVerbConjCAR(String title, String text) {
		super(title, text);
	...
	private void getModifiedStem() {
		...
		if(text.contains("gl-conj-car")){
			int verbNameIndex = text.indexOf("gl-conj-car");
	...
	public List<MorphoForm> getForms() {
		...
		int[] modifiedStemForms = { 18, 42, 43, 44, 45, 46, 47, 61, 62, 63, 64, 65, 66, 67, 68, 69 };
