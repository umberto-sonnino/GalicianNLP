...
public class GLMorphoRuleVerbConjAR extends GLMorphoRuleVerb {
	...
	public List<MorphoForm> getForms() {
		List<MorphoForm> forms = new ArrayList<MorphoForm>();
		...
		/*---PERSONAL INFINITIVE---*/
		forms.add(new GLMorphoFormVerb(stem + "ar", "personal infiniteve", "first singular"));		//71
		forms.add(new GLMorphoFormVerb(stem + "ares", "personal infiniteve", "first singular"));
		forms.add(new GLMorphoFormVerb(stem + "ar", "personal infiniteve", "third singular"));
		forms.add(new GLMorphoFormVerb(stem + "armos", "personal infiniteve", "first plural"));
		forms.add(new GLMorphoFormVerb(stem + "ardes", "personal infiniteve", "second plural"));
		forms.add(new GLMorphoFormVerb(stem + "aren", "personal infiniteve", "third plural"));		//76
